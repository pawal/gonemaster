...
| `CN05_ANSWER_FITS_UDP` | `INFO` | [connectivity05](../tests/connectivity/connectivity05.md) | **no** |
| `CN05_ANSWER_NEEDS_TCP` | `NOTICE` | [connectivity05](../tests/connectivity/connectivity05.md) | **no** |
| `CN05_LARGE_ANSWER_DELIVERED_UDP` | `INFO` | [connectivity05](../tests/connectivity/connectivity05.md) | **no** |
| `CN05_LARGE_ANSWER_NO_UDP_ANSWER` | `WARNING` | [connectivity05](../tests/connectivity/connectivity05.md) | **no** |
| `CN05_SERVER_CAPS_UDP_ANSWER` | `INFO` | [connectivity05](../tests/connectivity/connectivity05.md) | **no** |
| `CN05_UDP_LOSS_SIZE_DEPENDENT` | `WARNING` | [connectivity05](../tests/connectivity/connectivity05.md) | **no** |

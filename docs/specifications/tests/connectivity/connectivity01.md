...
| Tag | Emitted when |
| --- | --- |
| `CN01_IPV4_DISABLED` | IPv4 is disabled and at least one IPv4 nameserver exists in AllNameservers set. |
| `CN01_IPV6_DISABLED` | IPv6 is disabled and at least one IPv6 nameserver exists in AllNameservers set. |

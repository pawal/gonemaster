...
- Required inputs:
  - Child nameserver list from [`ZoneNameservers`](../../nameserver-resolution.md#zonenameservers).
...
2. Resolve nameservers from [`ZoneNameservers`](../../nameserver-resolution.md#zonenameservers) and deduplicate by IP.

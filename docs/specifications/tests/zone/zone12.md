...
| `Z12_CSYNC_FOUND` | `ns` | `string` | Nameserver identity (`name/ip`). |
...
| `Z12_MULTIPLE_CSYNC` | `ns` | `string` | Nameserver identity (`name/ip`). |
| `Z12_MULTIPLE_CSYNC` | `count` | `int` | Number of CSYNC records returned. |
| `Z12_NO_CSYNC` | `ns` | `string` | Nameserver identity (`name/ip`). |
| `Z12_SERIAL_MISMATCH` | `ns` | `string` | Nameserver identity (`name/ip`). |

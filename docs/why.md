...
v2026.1 (June 2026). gonemaster releases continuously from CI: 69 tags, most
recently v1.7.7 on 7 September 2026. A change proposed upstream waits for a
...
| Release cadence | continuous from CI, 69 tags, v1.7.7 | about two feature releases a year |

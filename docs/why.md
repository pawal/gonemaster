...
v2026.1 (June 2026). gonemaster releases continuously from CI: 66 tags, most
recently v1.7.4 on 1 September 2026. A change proposed upstream waits for a
...
| Release cadence | continuous from CI, 66 tags, v1.7.4 | about two feature releases a year |

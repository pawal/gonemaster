 ...
 * Usage:
 *   {$t("pub.key")}
 *   {$t("pub.key_with_var", { domain: "example.com" })}
 *
 ...
 *
 * Interpolation: `{var}` placeholders are replaced with matching values from
 * `vars`. Extra vars are ignored; missing vars leave the placeholder literal.
 */
